...
var ASM_CONSTS = {
  9013276: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 9013331: ($0) => { performance.now = function() { return $0; }; },  
 9013379: ($0) => { performance.now = function() { return $0; }; },  
 9013427: () => { performance.now = Module['emscripten_get_now_backup']; }
};
