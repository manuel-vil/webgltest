...
var ASM_CONSTS = {
  9015484: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 9015539: ($0) => { performance.now = function() { return $0; }; },  
 9015587: ($0) => { performance.now = function() { return $0; }; },  
 9015635: () => { performance.now = Module['emscripten_get_now_backup']; }
};
